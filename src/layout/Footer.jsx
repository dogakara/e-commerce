      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-sm">
              Kaliteli ürünler, hızlı kargo ve güvenilir alışveriş deneyimi.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link to="/team" className="hover:text-white">Ekibimiz</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link to="/faq" className="hover:text-white">Sıkça Sorulan Sorular</Link></li>
              <li><Link to="/shipping" className="hover:text-white">Kargo & Teslimat</Link></li>
              <li><Link to="/returns" className="hover:text-white">İade & Değişim</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex space-x-4 mb-6">
              ...
              <a href="#" className="hover:text-white">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2a10 10 0 1010 10A10 10 0 0012 2zm4.93 6.07a6.5 6.5 0 01-9.86 8.79l-3.07.85.85-3.07a6.5 6.5 0 118.08-6.57z"/></svg>
              </a>
              <a href="#" className="hover:text-white">
